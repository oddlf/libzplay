...
WMp3x::WMp3x()
{
	...
	WAudioProcessor* processor = &c_InputProcessor;

#ifdef LIBZPLAY_DSP_SOUNDTOUCH
	processor->SetOutputProcessor(&c_SoundTouchProcessor);
	processor = &c_SoundTouchProcessor;
#endif
	processor->SetOutputProcessor(&c_EqualizerProcessor);
	...
	c_param3 = 0;
	c_param4 = 0;
#elif defined(LIBZPLAY_INPUT_VORBIS)
